...
public class Purchaser :Singleton<Purchaser> , IStoreListener
{
	...
	public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args) 
	{
		...
		{
			GameManager.Instance.OnSuccessfullIAP (args.purchasedProduct.definition.storeSpecificId);
	...
	public void OnPurchaseFailed(Product product, PurchaseFailureReason failureReason)
	{
		...
		GameManager.Instance.OnFailedIAP (product.definition.storeSpecificId, failureReason.ToString());
